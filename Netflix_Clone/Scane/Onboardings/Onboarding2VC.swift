...
class Onboarding2VC: UIViewController {
    ...
    func setupUI() {
        ...
        backgroundImg.image = UIImage(named: "onboarding2")
        ...
        subTitleLbl.text = "Save your data, watch offline on a \nplane, train, or submarine..."
        ...
        sliderImg.image = UIImage(named: "page2")
    ...
    @objc func didTapNext() {
        Presentation.presentVC(currentVC: self, destinationVC: Onboarding3VC(), toDirection: .right)
    }
}
