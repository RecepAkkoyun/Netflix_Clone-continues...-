...
class Onboarding1VC: UIViewController {
    ...
    func setupUI() {
        ...
        backgroundImg.image = UIImage(named: "onboarding1")
        ...
        subTitleLbl.text = "Stream on your phone, tablet, \nlaptop, and TV without paying \nmore."
        ...
        sliderImg.image = UIImage(named: "page1")
    ...
    @objc func didTapNext() {
        Presentation.presentVC(currentVC: self, destinationVC: Onboarding2VC(), toDirection: .right)
    }
}
